                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="mb-1">
                                <div className='mb-4'>
                                    <h1 className="text-2xl font-[500] text-[#7026A1]">Create Message</h1>
                                    ...
                                    <div className="overflow-auto max-h-[calc(100vh-310px)] p-1">
                                        <section className='bg-[#F5F7F5] p-4 rounded-lg'>
                                                ...
                                                <div className="form-group flex-col flex gap-2 mb-4">
                                                    <label htmlFor="productName" className="text-[#757575]">Patient</label>
                                                    <Select>
                                                ...
                                                <div className="form-group flex-col flex gap-2">
                                                    <label htmlFor="productName" className="text-[#757575]">Message</label>
