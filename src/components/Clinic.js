...
Array(20).fill({
id: "#547388",
clinic_name: "Physical Activity Level",
email: "kabirahmed@mail.com",
phone: "+1 234-432-9876",
website: "electronicsworld.io",
        ...
        <tbody>
          ...
          <tr key={i} className={`border-t border-[#EAECF0] whitespace-nowrap hover:bg-gray-50
            ...
            <td className="px-6 py-3 text-[#475467] text-[12px] font-[400]">
              <Link href={`/clinic_view?id=${encodeURIComponent(s.id)}`} className="flex items-center">
              {s.id}
              </Link>
            ...
            <td className="px-6 py-3 text-[#475467] text-[12px] font-[400]">
              <Link href={`/clinic_view?id=${encodeURIComponent(s.id)}`} className="flex items-center">
              <span className="border border-[#B7EFAB] bg-[#F8FFF8] text-[#177606] px-2 py-1 rounded-sm">
                {s.status}
              </span>
