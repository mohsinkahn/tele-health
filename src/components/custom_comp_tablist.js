...
import Detailinformation from './custom_comp_info';
import SupplierLogs from './custom_comp_logs';
// import Product from './Product';
// import Supplier_quotes from './supplier_quotes';
// import Supplier_event from './supplier_event';
import Supplier_report from './custom_comp_report';
import Supplier_order from './custom_comp_order';
import Supplier_complaints from './custom_comp_complaints';
import Supplier_attachments from './custom_comp_attachments';
import Supplier_financial from './custom_comp_financial';
import Supplier_notes_summary from './custom_comp_notes_summ';
