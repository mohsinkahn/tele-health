                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="mb-1">
                                <div className='mb-4'>
                                    <h1 className="text-2xl font-[500] text-[#7026A1]">Add Clinics</h1>
                                        ...
                                        <section className='bg-[#F5F7F5] p-4 rounded-lg'>
                                            ...
                                            <div className="grid md:grid-cols-1 grid-cols-1 gap-4">
                                                ...
                                                <div className="form-group flex-col flex gap-2">
                                                    <label htmlFor="status" className="text-[#757575]">Clinic Name  </label>
                                                     <input
                                                        id="Clinic"
                                                        type="text"
                                                ...
                                                <div className="form-group flex-col flex gap-2">
                                                    <label htmlFor="productName" className="text-[#757575]">Website</label>
                                                    <input
                                                        id="Website"
                                                        type="text"
                                                        className="border border-[#EBEBEB] rounded-[8px] px-3 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-[#7026A1] bg-white"
                                            ...
                                            <div className="grid md:grid-cols-2 grid-cols-1 gap-4 mt-4 mb-4">
                                                <div className="form-group flex-col flex gap-2">
                                                    <label htmlFor="status" className="text-[#757575]">Phone Number</label>
                                                ...
                                                <div className="form-group flex-col flex gap-2">
                                                    <label htmlFor="status" className="text-[#757575]">Email</label>
                                                    <input
                                                        id="Email"
                                                        type="text"
                                                        className="border border-[#EBEBEB] rounded-[8px] px-3 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-[#7026A1] bg-white"
                                            ...
                                            <div className="form-group flex-col flex gap-2">
                                                    <label htmlFor="productName" className="text-[#757575]">Address</label>
                                                    <input
                                                        id="Address"
                                                        type="text"
                                                        className="border border-[#EBEBEB] rounded-[8px] px-3 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-[#7026A1] bg-white"
                                                    ...
                                                    <div className="grid md:grid-cols-2 grid-cols-1 gap-4 mt-4 mb-4">
                                                <div className="form-group flex-col flex gap-2">
                                                    <label htmlFor="status" className="text-[#757575]">License Number</label>
                                                ...
                                                <div className="form-group flex-col flex gap-2">
                                                    <label htmlFor="status" className="text-[#757575]">License Expiry</label>
                                                     <div className="relative w-full">
                                                        <input
                                                            id="date"
                                                            type="date"
                                                            className="border border-[#D0D5DD] rounded-[8px] px-3 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-[#7026A1] w-full pr-2 appearance-none bg-white"
                                                        />
                                                ...
                                                <div className="form-group flex-col flex gap-2">
                                                    <label htmlFor="productName" className="text-[#757575]">Plan</label>
                                                    <Select>
