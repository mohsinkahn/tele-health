...
id_no: `#5473${i + 1}`,
complaint:complaintWords[Math.floor(Math.random() * complaintWords.length)],
appointment_date: "25 - July - 2024",
doctors:doctorWords[Math.floor(Math.random() * doctorWords.length)],
                                    ...
                                    <th className="px-4 py-3">
                                        <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                            ...
                                            <path
                                                ...
                                                stroke="#144A6C" stroke-width="1.5" stroke-linecap="round"></path>
                                        </svg>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr key={i} className={`border-t border-[#EAECF0] whitespace-nowrap hover:bg-gray-50
                                    ...
                                    {/* <td className="px-4 py-3">
                                        <input type="checkbox" checked={selectedRows.includes(i)} onChange={()=>
                                        toggleRow(i)} className="row-check"
                                        />
                                    </td> */}
                                    ...
                                    <td className="text-center">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <svg width="19" height="19" viewBox="0 0 19 19" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M10.25 1C10.25 0.447715 9.80229 0 9.25 0C8.69772 5.96046e-08 8.25 0.447715 8.25 1L9.25 1L10.25 1ZM8.25 11.0833C8.25 11.6356 8.69772 12.0833 9.25 12.0833C9.80229 12.0833 10.25 11.6356 10.25 11.0833L9.25 11.0833H8.25ZM13.6238 9.95711C14.0143 9.56658 14.0143 8.93342 13.6238 8.54289C13.2332 8.15237 12.6001 8.15237 12.2096 8.54289L12.9167 9.25L13.6238 9.95711ZM9.89818 12.2685L9.19107 11.5614L9.89818 12.2685ZM8.60182 12.2685L9.30893 11.5614H9.30893L8.60182 12.2685ZM6.29044 8.54289C5.89992 8.15237 5.26675 8.15237 4.87623 8.54289C4.4857 8.93342 4.4857 9.56658 4.87623 9.95711L5.58333 9.25L6.29044 8.54289ZM2 12.9167C2 12.3644 1.55228 11.9167 1 11.9167C0.447715 11.9167 0 12.3644 0 12.9167H1H2ZM18.5 12.9167C18.5 12.3644 18.0523 11.9167 17.5 11.9167C16.9477 11.9167 16.5 12.3644 16.5 12.9167H17.5H18.5ZM15.9985 17.2003L15.5445 16.3093H15.5445L15.9985 17.2003ZM17.2003 15.9985L18.0913 16.4525L17.2003 15.9985ZM1.29973 15.9985L0.408726 16.4525L1.29973 15.9985ZM2.50153 17.2003L2.04754 18.0913H2.04754L2.50153 17.2003ZM9.25 1L8.25 1L8.25 11.0833H9.25L10.25 11.0833L10.25 1L9.25 1ZM12.9167 9.25L12.2096 8.54289L9.19107 11.5614L9.89818 12.2685L10.6053 12.9756L13.6238 9.95711L12.9167 9.25ZM8.60182 12.2685L9.30893 11.5614L6.29044 8.54289L5.58333 9.25L4.87623 9.95711L7.89471 12.9756L8.60182 12.2685ZM9.89818 12.2685L9.19107 11.5614C9.22362 11.5288 9.27638 11.5288 9.30893 11.5614L8.60182 12.2685L7.89471 12.9756C8.64322 13.7241 9.85678 13.7241 10.6053 12.9756L9.89818 12.2685ZM1 12.9167H0V13.1H1H2V12.9167H1ZM5.4 17.5V18.5H13.1V17.5V16.5H5.4V17.5ZM17.5 13.1H18.5V12.9167H17.5H16.5V13.1H17.5ZM13.1 17.5V18.5C13.8536 18.5 14.4789 18.5008 14.9876 18.4592C15.508 18.4167 15.9939 18.3249 16.4525 18.0913L15.9985 17.2003L15.5445 16.3093C15.4148 16.3753 15.2215 16.4334 14.8248 16.4659C14.4164 16.4992 13.8866 16.5 13.1 16.5V17.5ZM17.5 13.1H16.5C16.5 13.8866 16.4992 14.4164 16.4659 14.8248C16.4334 15.2215 16.3753 15.4148 16.3093 15.5445L17.2003 15.9985L18.0913 16.4525C18.3249 15.9939 18.4167 15.508 18.4592 14.9876C18.5008 14.4789 18.5 13.8536 18.5 13.1H17.5ZM15.9985 17.2003L16.4525 18.0913C17.1581 17.7318 17.7317 17.1581 18.0913 16.4525L17.2003 15.9985L16.3093 15.5445C16.1415 15.8738 15.8738 16.1415 15.5445 16.3093L15.9985 17.2003ZM1 13.1H0C0 13.8536 -0.000777721 14.4789 0.0407876 14.9876C0.0833067 15.508 0.175059 15.9939 0.408726 16.4525L1.29973 15.9985L2.19074 15.5445C2.12467 15.4148 2.06656 15.2215 2.03415 14.8248C2.00078 14.4164 2 13.8866 2 13.1H1ZM5.4 17.5V16.5C4.61343 16.5 4.08364 16.4992 3.67524 16.4659C3.27851 16.4334 3.08518 16.3753 2.95552 16.3093L2.50153 17.2003L2.04754 18.0913C2.50613 18.3249 2.99196 18.4167 3.51237 18.4592C4.02111 18.5008 4.64643 18.5 5.4 18.5V17.5ZM1.29973 15.9985L0.408726 16.4525C0.768251 17.1581 1.34193 17.7318 2.04754 18.0913L2.50153 17.2003L2.95552 16.3093C2.62623 16.1415 2.35852 15.8738 2.19074 15.5445L1.29973 15.9985Z"
                                                    fill="#7026A1" />
                                            </svg>
