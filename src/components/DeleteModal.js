...
<AnimatePresence>
    ...
    <>
        ...
        <motion.div className="fixed inset-0 flex justify-center items-center z-50"
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg lg:w-[700px] w-full relative" onClick={(e)=>
                ...
                <div className="mb-1">
                    <div className='mb-4 flex gap-2 items-center'>
                        <Trash className="text-red-800 bg-[#FAF5F5] p-4 w-15 h-15 rounded-full size-10" />
                        <h1 className="text-2xl font-[500] text-[#7026A1]">Delete</h1>
                            ...
                            <section className=' p-4 rounded-lg'>
                                <div className="form-group flex-col flex gap-2 mb-4">
                                    ...
                                    <div className="flex justify-end gap-2 mt-4">
                                        ...
                                        <button
                                            type="submit"
                                            className="btn btn-danger bg-red-700 text-white"
                                        >
                                            Delete
                                        </button>
                                    </div>
