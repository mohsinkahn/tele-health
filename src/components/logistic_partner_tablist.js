...
import Detailinformation from './logistic_partner_info';
import SupplierLogs from './logistic_partner_logs';
// import Product from './Product';
// import Supplier_quotes from './supplier_quotes';
// import Supplier_event from './supplier_event';
import Supplier_report from './logistic_partner_report';
import Supplier_order from './logistic_partner_order';
import Supplier_complaints from './logistic_partner_complaints';
import Supplier_attachments from './logistic_partner_attachments';
import Supplier_financial from './logistic_partner_financial';
import Supplier_notes_summary from './logistic_partner_notes_summ';
