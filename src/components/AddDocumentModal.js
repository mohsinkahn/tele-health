                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="mb-1">
                                <div className='mb-4'>
                                    <h1 className="text-2xl font-[500] text-[#7026A1]">Add Document</h1>
                                    ...
                                    <div className="overflow-auto max-h-[calc(100vh-310px)] p-1">
                                        <section className='bg-[#F5F7F5] p-4 rounded-lg'>
                                            ...
                                            <div className="grid md:grid-cols-1 grid-cols-1 gap-4">
                                                ...
                                                <div className="form-group flex-col flex gap-2 mt-4 mb-4">
                                                    <label htmlFor="productName" className="text-[#757575]">File Type</label>
                                                    <Select>
                                           ...
                                           <div className="form-group  mt-4 mb-4">
                                            <label htmlFor="productName" className="text-[#757575]">Document</label>
