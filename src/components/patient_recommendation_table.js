...
export default function PatientRecommendationTable() {
...
complaint: "Fainting",
recommendation: "Lorem ipsum dolor sit amet consectetur. Purus diam lorem duis phasellus massa quis.",
...
<div className=" mx-auto ">
    ...
    <div className="bg-white rounded-xl shadow-custom border border-gray-100 p-4 flex flex-col">
        ...
        <div className="bg-white overflow-auto lg:max-h-[calc(100vh-290px)] max-h-[calc(100vh-557px)] ">
