                ...
                <>
                    ...
                    <motion.div className="fixed inset-0 flex justify-center items-center z-50"
                        ...
                        >
                            ...
                            <div className="mb-1">
                                <div className='mb-4'>
                                    <h1 className="text-2xl font-[500] text-[#7026A1]">Add Allergies</h1>
                                        ...
                                        <section className='bg-[#F5F7F5] p-4 rounded-lg'>
                                            ...
                                            <div className="w-full space-y-6">
                                                ...
                                                <div className="flex justify-between items-center pt-5">
                                                    <h2 className="text-[#757575] font-medium">Allergies</h2>
                                                ...
                                                {medicines.map((med, index) => (
                                                    <div key={med.id} className="bg-[#F8F8F8] border border-gray-200 rounded-2xl p-5">
                                                        ...
                                                        <div className="grid lg:grid-cols-1 grid-cols-1 gap-4 mb-4">
                                                            <div>
                                                                <label htmlFor="status" className="text-[#757575]">Cause of Allergy Item Name</label>

                                                                <input type="text" placeholder="Birds, Any Food, Dust, Animals etc.." value={med.name}
