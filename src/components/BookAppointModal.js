...
const BookAppointModal = ({ isOpen, onClose }) => {
                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="mb-1">
                                <div className='mb-4'>
                                    <h1 className="text-2xl font-[500] text-[#7026A1]">Book Appointment</h1>
                                        ...
                                        <section className='bg-[#F5F7F5] p-4 rounded-lg'>
                                            ...
                                            <div className="grid md:grid-cols-1 grid-cols-1 gap-4">
                                                ...
                                                <div className="form-group flex-col flex gap-2">
                                                    <label htmlFor="status" className="text-[#757575]">Patient</label>
                                                    <Select>
                                                        <SelectTrigger className="w-full h-[46px] focus:outline-none focus:ring-1 focus:ring-[#355E5B] border border-[#EBEBEB] px-2 py-3 rounded-[8px] font-poppins bg-white">
                                                ...
                                                <div className="form-group flex-col flex gap-2">
                                                    <label htmlFor="productName" className="text-[#757575]">Complaint</label>
                                                    <input
                                                        id="Complaint"
                                                        type="text"
                                                        className="border border-[#EBEBEB] rounded-[8px] px-3 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-[#355E5B] bg-white"
                                                        required
                                                    />
                                                </div>
                                            ...
                                            <div className="grid md:grid-cols-2 grid-cols-1 gap-4 mt-4">
                                                <div className="form-group flex-col flex gap-2">
                                                    <label htmlFor="status" className="text-[#757575]">Booking Date</label>
                                                    <Select>
                                                        <SelectTrigger className="w-full h-[46px] focus:outline-none focus:ring-1 focus:ring-[#355E5B] border border-[#EBEBEB] px-2 py-3 rounded-[8px] font-poppins bg-white">
                                                            <SelectValue placeholder="Select" />
                                                        </SelectTrigger>
                                                ...
                                                <div className="form-group flex-col flex gap-2">
                                                    <label htmlFor="status" className="text-[#757575]">Open Slots</label>
                                                    <Select>
                                                        <SelectTrigger className="w-full h-[46px] focus:outline-none focus:ring-1 focus:ring-[#355E5B] border border-[#EBEBEB] px-2 py-3 rounded-[8px] font-poppins bg-white">
                                                            <SelectValue placeholder="Select" />
                                                        </SelectTrigger>
