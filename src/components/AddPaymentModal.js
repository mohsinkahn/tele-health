    ...
    <>
        ...
        <motion.div className="fixed inset-0 flex justify-center items-center z-50"
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg lg:w-[1300px] w-full relative" onClick={(e)=>
                ...
                <div className="mb-1">
                    <div className='mb-4'>
                        <h1 className="text-2xl font-[500] text-[#7026A1]">Record Payment</h1>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="overflow-auto max-h-[calc(100vh-310px)] p-1">
                            <section className='bg-[#F5F7F5] p-4 rounded-lg'>
                                <div className="flex justify-between items-center bg-[#F8F9FA] py-4 px-1 rounded-md">
                                    {/* Left Side */}
                                    <div className="flex flex-col">
                                        <span className="text-gray-600 text-sm">Record Payment</span>

                                        <div className="flex items-center gap-6 mt-2">
                                            {/* Partial Payment */}
                                            <label className="flex items-center gap-2 cursor-pointer">
                                                <input type="radio" name="payment" value="partial"
                                                    checked={paymentType==="partial" } onChange={()=>
                                                setPaymentType("partial")}
                                                className="appearance-none h-4 w-4 border border-gray-400 rounded-full
                                                checked:bg-[#7026A1] checked:border-[#7026A1] relative
                                                after:content-[''] after:absolute after:top-[3px] after:left-[3px]
                                                after:h-2 after:w-2 after:rounded-full after:bg-white after:opacity-0
                                                checked:after:opacity-100 transition-all duration-200"
                                                />
                                                <span className="text-gray-700 text-sm">Partial Payment</span>
                                            </label>

                                            {/* Full Payment */}
                                            <label className="flex items-center gap-2 cursor-pointer">
                                                <input type="radio" name="payment" value="full"
                                                    checked={paymentType==="full" } onChange={()=>
                                                setPaymentType("full")}
                                                className="appearance-none h-4 w-4 border border-gray-400 rounded-full
                                                checked:bg-[#7026A1] checked:border-[#7026A1] relative
                                                after:content-[''] after:absolute after:top-[3px] after:left-[3px]
                                                ...
                                                checked:after:opacity-100 transition-all duration-200"
                                                />
                                                <span className="text-gray-700 text-sm">Full Payment</span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div className="text-right">
                                        <span className="text-gray-600 text-sm block">Pending Amount</span>
                                        <span className="text-[#7026A1] font-semibold text-lg">$13,408.17</span>
                                    </div>
                                </div>
                                ...
                                <div className="grid md:grid-cols-1 grid-cols-1 gap-4">
                                    ...
                                    <div className="form-group flex-col flex gap-2">
                                        <label htmlFor="status" className="text-[#757575]">Method </label>
                                        <Select>
                                            <SelectTrigger
                                    ...
                                    <div className="form-group flex-col flex gap-2">
                                        <label htmlFor="productName" className="text-[#757575]">Insurance
                                            Provider</label>
                                ...
                                <div className="grid md:grid-cols-1 grid-cols-1 gap-4 mt-4 mb-4">

                                    <div className="form-group flex-col flex gap-2">
                                        <label htmlFor="status" className="text-[#757575]">Date</label>
                                ...
                                <div className="form-group flex-col flex gap-2">
                                    <label htmlFor="productName" className="text-[#757575]">Amount</label>
