                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="mb-1">
                                <div className='mb-4'>
                                    <h1 className="text-2xl font-[500] text-[#7026A1] text-left">Questionnaire</h1>
                                    ...
                                    <div className="overflow-auto max-h-[calc(100vh-310px)] p-1">
                                        <section className='bg-[#F5F7F5] p-4 rounded-lg'>
                                            ...
                                            <div className="grid md:grid-cols-1 grid-cols-1 gap-4">
                                                ...
                                                <div className="form-group flex-col flex gap-2 text-left">
                                                    <label htmlFor="status" className="text-[#757575]">What time did the trauma occured?  </label>
                                                     <input
                                                        id="Wh"
                                                        type="text"
                                              ...
                                              <div className="form-group flex-col flex gap-2 mt-4 mb-4 text-left">
                                                    <label htmlFor="productName" className="text-[#757575]">Is the patient on some prescription?</label>
                                                    <Select>
                                                ...
                                                <div className="form-group flex-col flex gap-2 text-left">
                                                    <label htmlFor="status" className="text-[#757575]">What were the symptoms?  </label>
                                                     <input
                                                        id="Wh"
                                                        type="text"
                                                        className="border border-[#EBEBEB] rounded-[8px] px-3 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-[#7026A1] bg-white"
                                           ...
                                           <div className="form-group  mt-4 mb-4 text-left">
                                            <label htmlFor="productName" className="text-[#757575]">Picture of the prescription the patient is taking</label>
