                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="mb-1">
                                <div className='mb-4'>
                                    <h1 className="text-2xl font-[500] text-[#7026A1]">Forms</h1>
                                        ...
                                        <section className='bg-[#F5F7F5] p-4 rounded-lg'>
                                            ...
                                            <div className="grid md:grid-cols-1 grid-cols-1 gap-4">
                                               ...
                                               <div className="form-group flex-col flex gap-2 mt-4 mb-4">
                                                    <label htmlFor="productName" className="text-[#757575]">Type</label>
                                                    <Select>
                                              ...
                                              <div className="form-group flex-col flex gap-2 mt-4 mb-4">
                                                    <label htmlFor="productName" className="text-[#757575]">Options</label>
                                                    <Select>
                                                        <SelectTrigger className="w-full h-[46px] focus:outline-none focus:ring-1 focus:ring-[#7026A1] border border-[#EBEBEB] px-2 py-3 rounded-[8px] font-poppins bg-white">
                                                            <SelectValue placeholder="Select" />
                                                        </SelectTrigger>
