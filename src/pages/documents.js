...
<>
 ...
 <AddDocumentModal
    ...
    <>
     <div className="px-2 py-2  lg:p-3 bg-white rounded-xl shadow-custom border border-gray-100  flex flex-col mt-4 lg:mx-5 ">
          <div className="overflow-auto lg:max-h-[calc(100vh-290px)] max-h-[calc(100vh-295px)]">
             <Document />
           </div>    
          </div>
