  ...
  <>
    ...
    <div
                ...
                <div className="flex gap-3 items-center">
                    ...
                    <div>
                        <Link href="#"
                            className="btn btn-light border-[#EEEEEE] border bg-white rounded-md pt-[9px] pb-[9px] px-5 mb-3" //
    ...
    <div className="flex w-full lg:pl-8 lg:pr-6 lg:pt-6 h-full">
      ...
      <div className="w-20   bg-white flex flex-col rounded-2xl justify-start items-center h-[100%] z-2">
        ...
        <button className={`text-left px-4 py-4 mt-3 rounded-lg bg-[#F8F8F8] ${activeTab==="tab1"
          ? "bg-[#FFE9F4] text-blue-600 font-semibold" : "text-gray-700" }`} onClick={()=> setActiveTab("tab1")}
          >
          <span>
        ...
        <button className={` text-left px-4 py-4 rounded-lg bg-[#F8F8F8] mt-3 ${activeTab==="tab2"
          ? "bg-[#FFE9F4] text-blue-600 font-semibold" : "text-gray-700" }`} onClick={()=> setActiveTab("tab2")}
          >
          <span>
        ...
        <button className={` text-left px-4 py-4 rounded-lg bg-[#F8F8F8] mt-3 ${activeTab==="tab3"
          ? "bg-[#FFE9F4] text-blue-600 font-semibold" : "text-gray-700" }`} onClick={()=> setActiveTab("tab3")}
          >
          <span>
        ...
        <button className={` text-left px-4 py-4 rounded-lg bg-[#F8F8F8] mt-3 ${activeTab==="tab4"
          ? "bg-[#FFE9F4] text-blue-600 font-semibold" : "text-gray-700" }`} onClick={()=> setActiveTab("tab4")}
          >
          <span>
        ...
        <button className={` text-left px-4 py-4 rounded-lg bg-[#F8F8F8] mt-3 ${activeTab==="tab5"
          ? "bg-[#FFE9F4] text-blue-600 font-semibold" : "text-gray-700" }`} onClick={()=> setActiveTab("tab5")}
          >
          <span>
        ...
        <button className={` text-left px-4 py-4 rounded-lg bg-[#F8F8F8] mt-3 ${activeTab==="tab6"
          ? "bg-[#FFE9F4] text-blue-600 font-semibold" : "text-gray-700" }`} onClick={()=> setActiveTab("tab6")}
          >
          <span>
