...
import SupplierViewComponent from "../components/potential_client_view";
  ...
  return (
    <div>
      {loading ? (
        ...
        <>
          <h1 className="text-2xl font-[500] text-[#101828]">Potential Client</h1>
          <p className="text-[#202E2D] font-[100] text-[14px] m-0">
            Manage and track client relationships, from first contact to long-term partnerships.
          </p>
          <hr className="mt-[20px] mb-[30px] text-[#EAECF0]" />
          <SupplierViewComponent ClientIdId={ClientId} />
        </>
      )}
    </div>
  );
