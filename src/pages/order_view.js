...
import SupplierViewComponent from "../components/order_view";
  ...
  return (
    <div>
      {loading ? (
        ...
        <>
          <h1 className="text-2xl font-[500] text-[#101828]">Order</h1>
          <p className="text-[#202E2D] font-[100] text-[14px] m-0">
            Manage all order across your network with detailed tracking of pricing, categories, and availability.
          </p>
          <hr className="mt-[20px] mb-[30px] text-[#EAECF0]" />
          <SupplierViewComponent ProductId={ProductId} />
        </>
      )}
    </div>
  );
